package NetworkServer.ru.geekbrains.java2.server.client;
...
import NetworkClientServer.ru.geekbrains.java2.client.CommandType;
import NetworkClientServer.ru.geekbrains.java2.client.command.AuthCommand;
import NetworkClientServer.ru.geekbrains.java2.client.command.BroadcastMessageCommand;
import NetworkClientServer.ru.geekbrains.java2.client.command.PrivateMessageCommand;
import NetworkServer.ru.geekbrains.java2.server.NetworkServer;
...
//                    History history = new History(nickname, id);
//                    history.createHistoryFile(message);
    ...
    private boolean processAuthCommand(Command command) throws IOException {
        ...
        id = networkServer.getAuthService().getUserIdByLoginAndPassword(login, password);
        if (username == null) {
